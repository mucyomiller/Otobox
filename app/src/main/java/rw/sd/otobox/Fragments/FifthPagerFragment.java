 ...
 */
public class FifthPagerFragment extends Fragment {
    private static final String TAG = "FifthPagerFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView.addItemDecoration(new FifthPagerFragment.GridSpacingItemDecoration(2, dpToPx(5), true));
    ...
    private  void  getProducts(String index){
        ...
        mSpare.filter(object ->{
            if(index.equals("mid") && object.getParseObject("category").get("order").toString().equals("4") && (object.getParseObject("generation") == null || object.getParseObject("generation").get("name").equals(generation.getName()))){
                return true;
            }else
            {
                return object.get("quality").toString().equals(index) && object.getParseObject("category").get("order").toString().equals("4") && (object.getParseObject("generation") == null || object.getParseObject("generation").get("name").equals(generation.getName()));
            }
